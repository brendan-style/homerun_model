...
import pandas as pd
arch_1 = pd.read_excel('archives.xlsx')
arch_2 = pd.read_excel('new_archive.xlsx')

arch_1 = arch_1[['sb_no_hr','pred_odds','hr','date']]
arch_2 = arch_2[['Under','pred_under','under_diff','hr','date']]

arch_1 = arch_1.rename(columns={'sb_no_hr':'Under','pred_odds':'pred_under'})
arch_1['Under'] = arch_1['Under']/100
arch_1['pred_under'] = round(arch_1['pred_under']/(arch_1['pred_under']-100),3)
arch_1['under_diff'] = arch_1.pred_under-arch_1.Under

archive = arch_1.append(arch_2).reset_index(drop=True)
#%%
import pandas as pd
